...
from src.schemas.practical import (TestNewAttempt, StudentAnswer, StudentAnswers, StudentMatchingList, StudentPractical,
                                   ExamNewAttempt, StudentAnswerDetail, StudentAnswersDetail, StudentMatchingDetail)
...
#             return question.q_score
#
#     def create_student_answer(self, new_attempt_id: int, question_score: int, answer: StudentAnswer):
#         answer_to_db = StudentAnswerDetail(
#             score=question_score,
#             question_id=answer.q_id,
#             question_type=answer.q_type,
...
#         self.student_repository.create_student_answer(answer_data=answer_to_db)
#
#     def create_student_answers(self, new_attempt_id: int, question_score: int, answer: StudentAnswers):
#         answers_to_db = StudentAnswersDetail(
#             score=question_score,
#             question_id=answer.q_id,
#             question_type=answer.q_type,
...
#         self.student_repository.create_student_answers(answers_data=answers_to_db)
#
#     def create_student_matching(self, new_attempt_id: int, question_score: int, answer: StudentMatchingList):
#         for match in answer.matching:
#             match_to_db = StudentMatchingDetail(
#                 score=(question_score/4),
#                 question_id=answer.q_id,
...
#         self._student_id = student_id
#         self._final_score = 0
#         self._test_id = self.get_test_id()
#
#     @property
#     def repository(self):
#         if self._repository is None:
...
#     def student_repository(self):
#         if self._student_repository is None:
#             self._student_repository = StudentTestRepository(db=self._db)
#         return self._student_repository
#
#     def get_test_id(self) -> int:
#         test_id = self.repository.select_test_id(lesson_id=self._lesson_id)
#         return test_id
#
#     def get_attempt_number(self) -> int:
#         last_attempt = self.student_repository.select_last_attempt_number(
